...
.code
       ...
       Op03:
			...
			invoke acumulate_opcode_cycles,6,1
			jmp Z80Loop
       Op04:
			;04		INC B			4	1	1
       ...
       OpC0:
			...
			test RegF,40h
			jz OpC9
			invoke acumulate_opcode_cycles,5,1
			jmp Z80Loop	
       OpC1:
			;C1		POP BC			10	3	1
	   ...
	   OpED01:
			...
			invoke acumulate_opcode_cycles,13,3
			jmp Z80Loop
	   OpED08:
			;ED08  IN  C,(n)	12	3
			invoke immediate_addressing_mode,memPtr
       ...
       OpED47:
			  ...
			  invoke acumulate_opcode_cycles,9,2
			  jmp Z80Loop 
       OpED48:
			  ;ED48  IN  C,(C)	12	3
       ...
       OpED67:
			   ...
			   invoke acumulate_opcode_cycles,18,5
			   jmp Z80Loop
       OpED68:
			  ;ED68  IN  L,(C)	12	3
